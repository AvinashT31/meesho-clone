  ...
  return (
    <>
      ...
      <nav className='navbar-bottom'>
        <ul>
          <li onMouseEnter={() => opennewdiv('one')} ><a>Women Ethnic</a></li>
          <li onMouseOver={() => opennewdiv('two')} ><a>Women Western</a></li>
          <li onMouseOver={() => opennewdiv('three')}><a>Mens</a></li>
          <li onMouseOver={() => opennewdiv('four')}><a>Kids</a></li>
          <li onMouseOver={() => opennewdiv('five')}><a>Home & Kitchen</a></li>
          <li onMouseOver={() => opennewdiv('six')}><a>Beauty & Health</a></li>
          <li onMouseOver={() => opennewdiv('seven')}><a>Jewellery & Accessories</a></li>
          <li onMouseOver={() => opennewdiv('eight')}><a>Bags & Footwear</a></li>
          <li onMouseOver={() => opennewdiv('nine')}><a>Electronics</a></li>
        </ul>
      </nav>

      {opennewpage === 'one' &&
        <div onMouseLeave={() => handleItemClick("one")} className='hiddendiv'>
          ...
          <div style={{ backgroundColor: "rgb(230, 240, 240)" }} className='hiddendivone'>
            ...
            <ul>
              <li><a>AllSarees</a></li>
              <li><a>Silk Sarees</a></li>
              <li><a>Cotton Silk Sarees</a></li>
              <li><a>Cotton Sarees</a></li>
              <li><a>Georgette Sarees</a></li>
              <li><a>Chiffon Sarees</a></li>
              <li><a>Embroidered Sarees</a></li>
              <li><a>Satin Sarees</a></li>
            </ul>
          </div>
          <div className='hiddendivone'>
            <p>Kurtis</p>
            <ul>
              <li><a>All Kurtis</a></li>
              <li><a>Anarkali Kurtis</a></li>
              <li><a>Rayon Kurtis</a></li>
              <li><a>Cotton Kurtis</a></li>
              <li><a>Embroidered Kurtis</a></li>
            </ul>
          </div>
          <div style={{ backgroundColor: "rgb(230, 240, 240)" }} className='hiddendivone'>
            <p>Kurta Sets</p>
            <ul>
              <li><a>All Kurta Sets</a></li>
            </ul>
          </div>
          <div className='hiddendivone'>
            <p>Suits & Dress Material</p>
            <ul>
              <li><a>All Suits & Dress Material</a></li>
              <li><a>Cotton Suits</a></li>
              <li><a>Embroidered Suits</a></li>
              <li><a>Chanderi Suits</a></li>
            </ul>
          </div>
          <div style={{ backgroundColor: "rgb(230, 240, 240)" }} className='hiddendivone'>
            <p>Other Ethnic</p>
            <ul>
              ...
              <li><a>Lehanga</a></li>
              <li><a>Gown</a></li>
              <li><a>Ethnic Bottomwear</a></li>
            </ul>
          </div>
        </div>}

      {opennewpage === 'two' &&
        <div onMouseLeave={() => handleItemClick('two')} className='hiddendiv'>
          <div className='hiddendivone'>
            <p>Topwear</p>
            <ul>
              <li><a>Tops</a></li>
      ...
      {opennewpage === 'three' &&
        <div onMouseLeave={() => handleItemClick('three')} className='hiddendiv'>
          <div className='hiddendivone'>
            <p>Topwear</p>
            <ul>
              <li><a>All Top Wears</a></li>
              <li><a>Tshirts</a></li>
              <li><a>Shirts</a></li>
            </ul>
          </div>
          ...
          <div className='hiddendivone'>
            <p>Ethnic Wear</p>
            <ul>
              <li><a>Men Kurtas</a></li>
              <li><a>Ethnic Jackets</a></li>
            </ul>
          </div>
          <div style={{ backgroundColor: "rgb(230, 240, 240)" }} className='hiddendivone'>
            <p>Inner & Sleep Wear</p>
            <ul>
              <li><a>All Inner & Sleep Wear</a></li>
              <li><a>Vests</a></li>
            </ul>
          </div>
        </div>}
      ...
      {opennewpage === 'four' &&
        <div onMouseLeave={() => handleItemClick('four')} className='hiddendiv'>
          <div className='hiddendivone'>
          ...
          <div style={{ backgroundColor: "rgb(230, 240, 240)" }} className='hiddendivone'>
            <p>Baby Care</p>
            <ul>
              <li><a>All Baby Care</a></li>
            </ul>
          </div>
        </div>}

      {opennewpage === 'five' &&
        <div onMouseLeave={() => handleItemClick('five')} className='hiddendiv'>
          <div className='hiddendivone'>
            <p>Home Furnishing</p>
            <ul>
              <li><a>Bedsheets</a></li>
              <li><a>Doormats</a></li>
              <li><a>Curtains & Sheers</a></li>
              <li><a>Cushions & Cushion Covers</a></li>
      ...
      {opennewpage === 'six' &&
        <div onMouseLeave={() => handleItemClick('six')} className='hiddendiv'>
          <div className='hiddendivone'>
            <p>Make up</p>
            <ul>
              <li><a>Face</a></li>
      ...
      {opennewpage === 'seven' &&
        <div onMouseLeave={() => handleItemClick('seven')} className='hiddendiv'>
          <div className='hiddendivone'>
            <p>Jewellery</p>
            <ul>
              <li><a>Jewellery Set</a></li>
              <li><a>Earnings</a></li>
              <li><a>Mangalsutras</a></li>
              <li><a>Studs</a></li>
              <li><a>Bangles</a></li>
              <li><a>Necklace</a></li>
              <li><a>Rings</a></li>
      ...
      {opennewpage === 'eight' &&
        <div onMouseLeave={() => handleItemClick('eight')} className='hiddendiv'>
          <div className='hiddendivone'>
            <p>Women Bags</p>
            <ul>
              <li><a>All Womens Bags</a></li>
              <li><a>Handbags</a></li>
              <li><a>Clutches</a></li>
              <li><a>Slingbags</a></li>
            </ul>
          ...
          <div style={{ backgroundColor: "rgb(230, 240, 240)" }} className='hiddendivone'>
            <p>Men Bags</p>
            <ul>
              <li><a>All Men Bags</a></li>
              <li><a>Mens Wallets</a></li>
            </ul>
          </div>
          <div className='hiddendivone'>
            <p>Men Footwear</p>
      ...
      {opennewpage === 'nine' &&
        <div onMouseLeave={() => handleItemClick('nine')} className='hiddendiv'>
          <div className='hiddendivone'>
            <p>Mobile & Accessories</p>
            <ul>
              <li><a >All Mobile & Accessories</a></li>
              <li><a >Smartwatches</a></li>
              <li><a >Mobile Holders</a></li>
              <li><a >Mobile cases and covers</a></li>
            </ul>
          </div>
          <div style={{ backgroundColor: "rgb(230, 240, 240)" }} className='hiddendivone'>
            <p>Appliances</p>
